...
Own vector spaces, projections, least squares, matrix maps, rank/nullspace, conditioning, SVD and eigenstructure.
...
- [Introduction to Linear Algebra](../library/src-ts-f03.md)
...
??? note "Record and evidence"
    ...
    Stable reference: `TS-F03`. Documentary availability is not learner mastery.

    [Editorial source record](../09-obelisk/curriculum-index.md#ts-f03)
