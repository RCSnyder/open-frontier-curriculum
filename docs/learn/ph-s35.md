# Technology, computation, information & AI
...
- [The Oxford Handbook of Philosophy of Technology](../library/src-ph-s011.md)
...
??? note "Record and evidence"
    ...
    Stable reference: `PH-S35`. Documentary availability is not learner mastery.

    [Editorial source record](../09-obelisk/curriculum-index.md#ph-s35)
