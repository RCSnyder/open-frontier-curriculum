...
**Source:** [source](https://davidtong.org/teaching/statistical-physics/)
...
1. **First law**: Energy-budget a closed thermal store including charging loss and heat leak.

2. **Entropy**: Compare two processes with identical energy balance but different entropy production.

3. **Carnot**: Find the maximum possible efficiency for a heat engine and show how radiator temperature changes system mass.

4. **Partition function**: Compute occupancy and heat capacity for a two-state system.

5. **Free energy**: Determine which of two phases/reactions is favored from free-energy data.

6. **Transport**: Estimate diffusion time across 1 mm, 1 cm and 1 m; explain why scaling matters.

7. **Heat transfer**: Compare conduction/convection/radiation for a high-temperature spacecraft component.

8. **Kinetic theory**: Estimate mean free path change with pressure and explain continuum breakdown.

9. **Phase transition**: Sketch a Landau-like free-energy landscape before/after a transition.

10. **Heat rejection**: Show why a high-power compact system can be limited by radiator area rather than fuel energy.

## Textbooks

See the [five-book resource page](../../07-resources/textbooks/thermodynamics-statistical-mechanics.md).
